...
const SbBadge = withStyles(() => ({ badge: { backgroundColor: '#edb926' } }))(
  Badge
);
...
const styles = theme => {
  ...
  return {
    ...
    activeTab: {
      color: '#ffffff',
      backgroundColor: dark ? '#453e68' : '#edb926',
      height: 60,
      marginTop: 20,
      padding: 10,
      '&:hover': {
        ...
        <Router>
          <div>
            <Navbar className={classes.navbarHeader} expand="lg" fixed="top">
              <NavbarBrand href="/">
                {' '}
                <img src={Logo} className={classes.logo} alt="SmartB Logo" />
              </NavbarBrand>
                ...
                >
                  ...
                  </div>
                  {
                    <div className={classes.adminButton}>
                      ...
                      />
                      <SbBadge badgeContent={notifyCount} />
                    </div>
                  }
                  {/*
